...
<div class="app">
    ...
    <div class="page" name="forecast">
        <?php include("Modules/club/app/client_forecast_view.php") ?>
    </div>

    <div class="page" name="household">
        <?php include("Modules/club/app/client_household_view.php") ?>
    </div>
   
    <div class="page" name="club">
        <?php include("Modules/club/app/client_club_view.php") ?>
    </div>
    
    <div class="page" name="tips">
        <?php include("Modules/club/app/client_tips_view.php") ?>
    </div>
