    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            for (var z in result) {
                ...
                out += "<td><a href='"+path+"club/admin-switchuser?userid="+result[z].id+"'>"+result[z].id+"</a>"+admin+"</td>";

                out += "<td>"+result[z].clubs_id+"</td>";
...
$("body").on("click",".check-household-breakdown",function(){
    var userid = $(this).attr("userid");
    $.ajax({
        url: path+"club/admin-check-household-breakdown",
        data: "userid="+userid,
        dataType: 'text',
        success: function(result) {
