...
<div id="wrapper">
    <div class="sidenav">
        <div class="sidenav-inner">
            <h4 style="color:white"><a id="all-clubs" href="<?php echo $path ?>club/admin" title="Show all Users">Clubs</a></h4>
            <ul id="clublist" class="sidenav-menu">
                <li><a href="#" data-href="<?php echo $path; ?>club/admin/clubs/new" data-toggle="modal" data-target="#newClubModal"><i class="icon-plus icon-white"></i> New</a></li>
            </ul>
        </div><!-- /.sidenav-inner-->
    </div><!-- /.sidenav-->
...
<template id="clublist-item">
    <li class="added">
        ...
        <a href="<?php echo $path; ?>club/admin/clubs/"></a>
    </li>
</template>
...
<div class="modal fade" id="newUserModal" tabindex="-1" role="dialog" aria-labelledby="newUserModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="create-user" style="margin:0" action="<?php echo $path ?>club/admin/clubs/new" method="POST" class="form-horizontal" autocomplete="off">
...
<div class="modal fade" id="editUserModal" tabindex="-1" role="dialog" aria-labelledby="editUserModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="edit-user" style="margin:0" action="<?php echo $path ?>club/admin/users" method="POST" class="form-horizontal">
...
<div class="modal fade" id="newClubModal" tabindex="-1" role="dialog" aria-labelledby="newClubModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="create-club" style="margin:0" action="<?php echo $path ?>club/admin/clubs/new" method="POST" class="form-horizontal">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
...
<div class="modal fade" id="editClubModal" tabindex="-1" role="dialog" aria-labelledby="editClubModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="edit-club" style="margin:0" action="<?php echo $path ?>club/admin/clubs" method="POST" class="form-horizontal">
...
<script src="<?php echo $path; ?>Modules/club/club.js"></script>
<script>
//initialise the sidebar
init_sidebar({
    menu_element: "#club_menu",
