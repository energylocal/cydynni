var feed = {
    ...
    listbyidasync: function(f)
    {
        ...
        var feeds = {};
        $.ajax({                                      
            url: path+club_name+"/feed/list.json"+apikeystr,
            dataType: 'json',
            async: true,                      
    ...
    getdata: function(id,start,end,interval,skipmissing,limitinterval)
    {
        ...
        var data = [];
        $.ajax({                                      
            url: path+club_name+"/feed/data.json"+apikeystr,                         
    ...
    getaverage: function(id,start,end,interval,skipmissing,limitinterval)
    {
        ...
        var data = [];
        $.ajax({                                      
            url: path+club_name+"/feed/average.json"+apikeystr,                         
    ...
    getmeta: function(id)
    {
        ...
        var meta = {};
        $.ajax({                                      
            url: path+club_name+"/feed/getmeta.json"+apikeystr,                         
            data: "id="+id,
            dataType: 'json',
            async: false,
            success: function(result) {
    ...
    {   
        var data = [];
        $.ajax({                                      
            url: path+club_name+"/app/dataremote",
    ...
    {   
        var value = 0;
        $.ajax({                                      
            url: path+club_name+"/app/valueremote",                       
