...
<head>
    ...
    <title>CydYnni Device Finder</title>
...
<body>
  <div class="oembluebar">
    <div class="oembluebar-inner">
      ...
      <div id="find" class="oembluebar-item" style="float:right"><?php echo t("Find Devices"); ?></div>
    </div>
  </div>
...
$("#find").click(function(){ window.location = path+club_name+"/find?lang="+lang; });
